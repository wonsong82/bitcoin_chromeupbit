...
namespace ChromeRemote
{
    public class Chrome
    {
        ...
        public void Connect(string socketUrl)
        {
            ...
            this._socket.OnOpen += delegate (object o, EventArgs e) {
                connectEvent.Set();
            };


            this._socket.OnMessage += delegate (System.Object o, MessageEventArgs e) {

                CommandResult result = JsonConvert.DeserializeObject<CommandResult>(e.Data);
